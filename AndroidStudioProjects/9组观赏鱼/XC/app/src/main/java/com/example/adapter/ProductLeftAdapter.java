...
public class ProductLeftAdapter extends RecyclerView.Adapter<ProductLeftAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public ProductLeftAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //关联列表选项布局
    ...
    @Override
    public void onBindViewHolder(@NonNull ProductLeftAdapter.ViewHolder holder, int position) {
